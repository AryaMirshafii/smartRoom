...
public class Room {
    ...
    public String toString() {
        return String.format("Room [id=%s, temperature=%s, visitorStatus=%s, lightsOn=%s, latitude=$%f, longitude=$%f, songPlaying=%s]", this.id, this.temperature,
                this.visitorStatus, this.lightsOn, this.latitude, this.longitude, this.songPlaying );
    }
